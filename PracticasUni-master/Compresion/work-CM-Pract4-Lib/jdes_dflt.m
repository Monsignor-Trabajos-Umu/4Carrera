...
% o Aplica tablas Huffman por defecto
% o Lee un archivo comprimido *.hud
% o Genera y almacena un archivo descomprimido *_des_def.bmp
...
tc = cputime;
% Leemos la imagen
[m, n, mamp, namp, caliQ, CodedY, CodedCb, CodedCr] = readHudfile(fname);
